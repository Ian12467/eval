...
<div class="col-lg-12">
	<div class="callout callout-info">
		<div class="d-flex w-100 justify-content-center align-items-center">
			<label for="faculty">Select Lecturer</label>
	...
	<div class="row">
		...
		<div class="col-md-9">
			...
			<hr>
			<center><h1>Defense Forces Technical College</h1></center>
			<div class="login-logo-center">
			<center><a href="#" class="text-white">
     <img src="assets/img/LOGO.jpg" alt="DEFTEC LOGO" width="150" height="150"></a></center>
	 <hr>
           </div>
			<table width="100%">
					<tr>
						<td width="50%"><p><b>Lecturer: <span id="fname"></span></b></p></td>
