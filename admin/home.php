      ...
      <div class="card-body ">
        ...
        <div class="col-md-5">
          <div class="callout callout-info">
            <h5><b>Academic Year: <?php echo $_SESSION['academic']['year'].' '.(ordinal_suffix1($_SESSION['academic']['semester'])) ?> Phase</b></h5>
        ...
        <div class="row">
          <div class="col-12 col-sm-6 col-md-4">
            <div class="small-box bg-purple light shadow-sm border">
              <div class="inner">
